...
public class DragonElytraItemListener implements Listener {

    private final WeaponMasterMain plugin;
    private final Util util;
    public DragonElytraItemListener(WeaponMasterMain plugin) {
        this.plugin = plugin;
    ...
    public DragonElytraItemListener regDragonElytraRunnable() {
        new BukkitRunnable() {
            @Override
            public void run() {
