...
public class EffectPicker {
    ...
    public static final Object[][] effects = {
            ...
            {10, PotionEffectType.SLOWNESS, 80, 600, 0, 4, 2},
            {10, PotionEffectType.HASTE, 80, 600, 0, 2, 1},
            {10, PotionEffectType.MINING_FATIGUE, 80, 600, 0, 2, 1},
            {10, PotionEffectType.STRENGTH, 80, 600, 0, 4, 2},
            {10, PotionEffectType.INSTANT_HEALTH, 1, 1, 0, 3, 1},
            {10, PotionEffectType.INSTANT_DAMAGE, 1, 1, 0, 3, 1},
            {10, PotionEffectType.JUMP_BOOST, 80, 600, 0, 7, 3},
            {10, PotionEffectType.NAUSEA, 80, 300, 0, 0, 0},
            {10, PotionEffectType.REGENERATION, 80, 400, 0, 3, 1},
            {10, PotionEffectType.RESISTANCE, 80, 400, 0, 4, 2},
